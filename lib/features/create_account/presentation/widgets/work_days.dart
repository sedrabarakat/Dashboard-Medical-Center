  ...
  return StatefulBuilder(
      builder: (BuildContext context, StateSetter setState){
        return AlertDialog(
            ...
            title: Text("Add Working Hours",style: StyleManager.font30Bold_Lobster.copyWith(
            ...
            content: Stack(
              children: [
                    ...
                    children: [
                      Row(
                        children: Days.map((item) => Padding(
                          ...
                          child: CustomElevatedButton(
                            ...
                            minimumSizeH: 50,
                            minimumSizeW: 140.w,
                            buttonColor: (Selected_Day==item)?ColorsHelper.onPressedColor:ColorsHelper.blueDark,
                          ),
                        )).toList(),
                      ),
                      SizedBox(
                      ...
                      Expanded(
                        child: ListView.separated(
                            itemBuilder: (context,index)=>TimesRow(context,onTimeFieldTap: () {
                              setState(() {
                ...
                Padding(
                  ...
                  child: SizedBox(
                      height: 500.h,width: 500.w,
                      child:  (Timerappear) ?
                      TimePickerDialog(initialTime: TimeOfDay.now(),cancelText: '',
                      ) :
                              (DateAppear)?
                      DatePickerDialog(firstDate: DateTime.now(), lastDate: DateTime(2090))
                          : SizedBox()
                  ),
                )
              ],
...
Widget TimesRow(context,Startcontroller,Endcontroller,{required onTimeFieldTap}){
